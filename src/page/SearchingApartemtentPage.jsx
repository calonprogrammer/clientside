...
`
class SearchingApartemtentPage extends Component {
	state = {
		properties :[],
		isLoading :true,
		coords: [0,0],
	...
	fetchNearby(){
		...
		axios.post(`http://127.0.0.1:8000/getNearbyApartement`,payload,config).then((response)=>{
...
export default SearchingApartemtentPage;